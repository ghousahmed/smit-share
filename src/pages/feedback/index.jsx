    ...
    <div className={`container ${isDark ? "dark" : ""}`}>
          ...
          {screenWidth.widthScreen > 768 ? (
            <ul>
              ...
              <li className="menu-btn">
                <Link
                  to="/login"
                  style={{ textDecoration: "none", color: "#638eff" }}
                >
                  Login
                </Link>{" "}
                /{" "}
          ...
          {isMenuOpen ? (
            <div className={`mobile-menu ${isDark ? "dark" : ""}`}>
              <ul style={{ backgroundColor: isDark ? "#252526" : "#f4f4f4" }}>
                ...
                <li className={isDark ? "dark" : " "} style={{ color: "#000" }}>
                  Feedback
                </li>
                {login ? (
      ...
      <div className="footer">
        <span>
          ...
          <Link
            className="link"
            to="https://www.linkedin.com/company/saylanimasstraining/?originalSubdomain=pk"
          >
            {" "}
            SMIT.com{" "}
          </Link>
